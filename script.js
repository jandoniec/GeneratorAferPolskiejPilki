...
function generateScandal() {
    ...
    const actions = [
        ...
        "używał obraźliwego języka wobec zawodników", "obstawiał wyniki meczów", "przepił cały budzet klubu"
    ];
    const reasons = [
        ...
        "po przegranej grze w karty", "z powodu przegranej zakładu", "bo nie lubi swojego szefa", 
        "bo był w złym humorze", "z powodu zepsutej fryzury", "bo stracił ulubioną koszulkę", "bo mu się nudziło", 
        "bo chciał udowodnić coś koledze", "bo był głodny", "bo mógł", "po kłótni z partnerką", "bo źle zrozumiał instrukcje", 
        ...
        "bo jego pies zjadł mu buty", "bo miał problemy z internetem", "bo miał konflikt z sąsiadem", 
        "bo bał się ciemności", "bo nie wyspał się poprzedniej nocy",  "bo przegapił autobus", 
        "bo miał konflikt z kolegą z drużyny", "bo nie mógł znaleźć swojej szczęśliwej monety", "bo przegrał zakład bukmacherski", 
